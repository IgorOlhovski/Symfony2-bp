...
/**
 * bp\Bundle\Entity\FormIcon
 *
 * @ORM\Table(name="form_icon")
 * @ORM\Entity(repositoryClass="bp\Bundle\Entity\FormIconRepository")
 *
 */
class FormIcon
{
     ...
     * Add user_teams
     *
     * @param \bp\Bundle\Entity\UserTeam $userTeams
     * @return FormIcon
     */
    public function addUserTeam(\bp\Bundle\Entity\UserTeam $userTeams)
    {
     ...
     * @param \bp\Bundle\Entity\UserTeam $userTeams
     */
    public function removeUserTeam(\bp\Bundle\Entity\UserTeam $userTeams)
    {
